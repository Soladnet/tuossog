			...
			<div class="all-notifications-list">
				...
				<div class="individual-notification-box">
                        ...
                        <div class="all-notification-text"> 
                            ...
                            <div class="all-notifications-message">wants to add you as a friend</div>
                        </div> 

                        <p>
	                        <a class="all-notifications-actions">Decline</a>
	                        <a class="all-notifications-actions">Accept</a>
	                        <a class="all-notifications-actions">View Profile</a>
                        </p>
