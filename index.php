		...
		<div class="index-content-wrapper">
			<div class="index-content">
				<div class="index-content-divs">
					...
					<hr>
					<p>
						Subscribe to communities. Be it campus, locality or based on interest   
						relevant to you and start talking.
					</p>
					<a href="">Learn more...</a>
				</div>
			...
			<div class="index-aside">
				<div class="index-aside-divs">
					...
					<hr>
					Discover <span class="tag"><a href="communities.php">Communities</a></span> 
