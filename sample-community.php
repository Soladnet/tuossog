		...
		<div class="content">
			...
			<div class="aside">
				<div class="aside-wrapper">
					...
					<div class="clear"></div>
					<br>
					<p class="profile-meta-functions button"><span ></span>More</p>
					<p class="profile-meta-functions button"><span class="icon-16-eye"></span> Invite Members</p>
					<p class="profile-meta-functions button"><span class="icon-16-chat"></span> Chat</p>
					<div class="clear"></div>
